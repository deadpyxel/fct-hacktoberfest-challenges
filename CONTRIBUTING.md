...
* Para cada issue, crie uma pasta para o problema se não existir, e em seguida uma pasta para a linguagem (se necessário)
* Leia atentamente os issues, e tire dúvidas se necessário.
* Siga o nosso Pull-Request template.
* Lembre-se de criar uma branch para a sua contribuição;
* Para o padrão de mensagens de commit, consulte o [Conventional Commits](https://www.conventionalcommits.org/pt-br/v1.0.0-beta.4/)
